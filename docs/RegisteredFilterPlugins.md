...
* Lossless compressopn only. For lossy compression use an HTJ2K library and write the chunk directly with `H5Dwrite_chunk`.
...
* No support for JPEG2000 "components"; no RGB image support.
