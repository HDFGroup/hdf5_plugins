...
macro (HDF5_SUPPORT link_hdf)
  ...
  if (NOT H5PL_HDF5_HEADER)
    ...
    if (${link_hdf})
      #plugin source needs to be linked with HDF5
      set (LINK_LIBS ${LINK_LIBS} ${H5PL_HDF5_LINK_LIBS})
    endif ()
  endif ()
  set (H5PL_INCLUDE_DIRS ${HDF5_INCLUDE_DIR})
  message (STATUS "HDF5 link libs: ${H5PL_HDF5_LINK_LIBS} Includes: ${H5PL_INCLUDE_DIRS}")
...
#      set (CPACK_PACKAGE_ICON "${${PLUGIN_PACKAGE_NAME}_RESOURCES_DIR}/h5mafisc.gif")
...
#        set (CPACK_BUNDLE_ICON "${${PLUGIN_PACKAGE_NAME}_RESOURCES_DIR}/H5MAFISC.icns")
