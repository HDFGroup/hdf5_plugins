...
macro (H5MAFISC_SET_LIB_OPTIONS libtarget defaultlibname libtype)
  ...
  H5MAFISC_SET_BASE_OPTIONS (${libtarget} ${libname} ${libtype})
  ...
  if (APPLE)
    ...
    endif (H5MAFISC_BUILD_WITH_INSTALL_NAME)
  endif (APPLE)

endmacro (H5MAFISC_SET_LIB_OPTIONS)
...
#-------------------------------------------------------------------------------
macro (H5MAFISC_SET_BASE_OPTIONS libtarget libname libtype)
  if (${libtype} MATCHES "SHARED")
    if (WIN32)
...
endmacro (H5MAFISC_SET_BASE_OPTIONS)
...
endmacro (H5MAFISC_IMPORT_SET_LIB_OPTIONS)
...
#-----------------------------------------------------------------------------
macro (H5MAFISC_README_PROPERTIES)
  ...
  configure_file (
      ${H5MAFISC_RESOURCES_DIR}/README.txt.cmake.in 
      ${CMAKE_BINARY_DIR}/README.txt @ONLY
  )
endmacro (H5MAFISC_README_PROPERTIES)
...
endmacro (EXTERNAL_MAFISC_LIBRARY)
...
endmacro (PACKAGE_MAFISC_LIBRARY)
