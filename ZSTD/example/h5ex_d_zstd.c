...
main (void)
{
    ...
    if (avail) {
        ...
        if ( (filter_config & H5Z_FILTER_CONFIG_ENCODE_ENABLED) &&
            ...
            fprintf (stdout, "zstd filter is available for encoding and decoding.\n");
    }
    else {
     ...
     */
    fprintf (stdout, "....Writing zstd compressed data ................\n");
     ...
     */
    fprintf (stdout, "....Reading zstd compressed data ................\n");
     ...
     */
    fprintf (stdout, "ZSTD number of differing array elements=%d\n", num_diff);
    /*
     * Check that filter is registered with the library now.
     */
    avail = H5Zfilter_avail(H5Z_FILTER_ZSTD);
    if (avail)
        fprintf (stdout, "zstd filter is available now since H5Dread triggered loading of the filter.\n");
