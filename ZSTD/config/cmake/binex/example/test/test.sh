...
$H5CC -shlib $srcdir/h5ex_d_zstd.c -o h5ex_d_zstd

SRC_TESTFILES="$srcdir/testfiles"
LIST_TEST_FILES="
$SRC_TESTFILES/h5repack_layout.h5
$SRC_TESTFILES/h5ex_d_zstd.ddl
$SRC_TESTFILES/h5ex_d_zstd.tst
...
EXETEST h5ex_d_zstd h5ex_d_zstd.tst

DUMPTEST h5ex_d_zstd.ddl h5ex_d_zstd.h5

REPACKTEST h5repack_layout.h5 out-ud_convert.h5repack_layout.h5 -v -f UD=307,1,5
