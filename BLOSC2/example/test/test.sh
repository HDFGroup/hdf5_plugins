...
$H5CC -shlib $srcdir/h5ex_d_blosc2.c -o h5ex_d_blosc2

SRC_TESTFILES="$srcdir/testfiles"
LIST_TEST_FILES="
$SRC_TESTFILES/h5repack_layout.h5
$SRC_TESTFILES/h5ex_d_blosc2.ddl
$SRC_TESTFILES/h5ex_d_blosc2.tst
...
EXETEST h5ex_d_blosc2 h5ex_d_blosc2.tst

DUMPTEST h5ex_d_blosc2.ddl h5ex_d_blosc2.h5

REPACKTEST h5repack_layout.h5 out-ud_convert.h5repack_layout.h5 -v -f UD=32026,0,0
