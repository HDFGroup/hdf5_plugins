HDF5 "out-ud_convert_zlib.h5repack_layout.h5" {
GROUP "/" {
   DATASET "dset1" {
   ...
   DATASET "dset_chunk" {
      ...
      STORAGE_LAYOUT {
         CHUNKED ( 20, 10 )
         SIZE 1928 (1.660:1 COMPRESSION)
      }
      FILTERS {
         USER_DEFINED_FILTER {
            FILTER_ID 32026
            COMMENT HDF5 blosc2 filter; see https://github.com/HDFGroup/hdf5_plugins/blob/master/docs/RegisteredFilterPlugins.md
            PARAMS { 1 0 4 800 5 1 4 2 20 10 }
         }
      }
      FILLVALUE {
         FILL_TIME H5D_FILL_TIME_IFSET
