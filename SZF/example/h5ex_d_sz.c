...
/************************************************************
  ...
  using szf compression.
  szf filter is not available in HDF5.
...
main (void)
{
    ...
    if (avail) {
        ...
        if ( (filter_config & H5Z_FILTER_CONFIG_ENCODE_ENABLED) &&
            ...
            printf ("szf filter is available for encoding and decoding.\n");
    }
    else {
     ...
     */
    printf ("....Writing szf compressed data ................\n");
    ...
    /*
     * Retrieve and print the filter id, compression level and filter's name for szf.
     */
     ...
     */
    printf ("....Reading szf compressed data ................\n");
    ...
    avail = H5Zfilter_avail(H5Z_FILTER_SZ);
    if (avail)
        printf ("szf filter is available now since H5Dread triggered loading of the filter.\n");
