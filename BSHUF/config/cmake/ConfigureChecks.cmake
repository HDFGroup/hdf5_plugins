...
if (APPLE)
  ...
  if (ARCH_LENGTH GREATER 1)
    ...
    message(FATAL_ERROR "Building Universal Binaries on OS X is NOT supported by the H5BSHUF project. This is"
...
macro (H5BSHUF_FUNCTION_TEST OTHER_TEST)
  if (NOT DEFINED ${OTHER_TEST})
    set (MACRO_CHECK_FUNCTION_DEFINITIONS "-D${OTHER_TEST} ${CMAKE_REQUIRED_FLAGS}")

    foreach (def ${H5BSHUF_EXTRA_TEST_DEFINITIONS})
...
H5BSHUF_FUNCTION_TEST (STDC_HEADERS)
...
set (H5BSHUF_EXTRA_C_FLAGS)
set (H5BSHUF_EXTRA_FLAGS)
if (NOT WINDOWS)
  if (NOT HAVE_SOLARIS)
  # Linux Specific flags
  set (H5BSHUF_EXTRA_C_FLAGS -D_POSIX_C_SOURCE=200112L)

  option (H5BSHUF_ENABLE_LARGE_FILE "Enable support for large (64-bit) files on Linux." ON)
  if (H5BSHUF_ENABLE_LARGE_FILE AND NOT DEFINED TEST_LFS_WORKS_RUN)
    ...
    if (TEST_LFS_WORKS_COMPILE)
      if (TEST_LFS_WORKS_RUN MATCHES 0)
        ...
        set (LARGEFILE 1)
        set (H5BSHUF_EXTRA_FLAGS ${H5BSHUF_EXTRA_FLAGS} -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -D_LARGEFILE_SOURCE)
  ...
  set (CMAKE_REQUIRED_DEFINITIONS ${CMAKE_REQUIRED_DEFINITIONS} ${H5BSHUF_EXTRA_FLAGS})
  endif ()
endif ()

add_definitions (${H5BSHUF_EXTRA_FLAGS})
#-----------------------------------------------------------------------------
