...
if (NOT DEFINED INSTALLDIR)
  if (WIN32)
    set (INSTALLDIR "%ProgramFiles%/HDF_Group/HDF5/${CTEST_SOURCE_VERSION}/${CMAKE_INSTALL_LIBDIR}/plugin")
  else ()
    set (INSTALLDIR "${CTEST_SCRIPT_DIRECTORY}/HDF_Group/HDF5/${CTEST_SOURCE_VERSION}/${CMAKE_INSTALL_LIBDIR}/plugin")
  endif ()
endif ()
