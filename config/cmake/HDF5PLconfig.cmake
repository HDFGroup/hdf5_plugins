...
set (CTEST_SOURCE_VERSION "2.2.0")
...
#CTEST_SOURCE_NAME - name of source folder; HDF5PL-2.0.x
...
if (NOT DEFINED INSTALLDIR)
  if (WIN32)
    set (INSTALLDIR "%ProgramFiles%/HDF_Group/HDF5/lib/plugin/${CTEST_SOURCE_VERSION}")
  else ()
    set (INSTALLDIR "${CTEST_SCRIPT_DIRECTORY}/HDF_Group/HDF5/lib/plugin/${CTEST_SOURCE_VERSION}")
  endif ()
endif ()
...
if (NOT DEFINED CTEST_SOURCE_NAME)
  set (CTEST_SOURCE_NAME "hdf5_plugins-${CTEST_SOURCE_VERSION}${CTEST_SOURCE_VERSEXT}")
endif ()
...
set (REPOSITORY_URL "https://github.com/HDFGroup/hdf5_plugins.git")
...
if (WIN32 AND NOT MINGW)
  set (BINFILEBASE "HDF5PL-${CTEST_SOURCE_VERSION}${CTEST_SOURCE_VERSEXT}-win${SITE_OS_BITS}")
  include (${CTEST_SCRIPT_DIRECTORY}\\HDF5PLoptions.cmake)
  ...
  set (BINFILEBASE "HDF5PL-${CTEST_SOURCE_VERSION}${CTEST_SOURCE_VERSEXT}")
  include (${CTEST_SCRIPT_DIRECTORY}/HDF5PLoptions.cmake)
  include (${CTEST_SCRIPT_DIRECTORY}/CTestScript.cmake)
  if (APPLE)
