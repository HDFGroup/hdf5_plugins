...
static size_t H5Z_filter_jpeg(unsigned int flags, size_t cd_nelmts, const unsigned int cd_values[],
 ...
 */
static size_t
H5Z_filter_jpeg(unsigned int flags, size_t cd_nelmts, const unsigned int cd_values[], size_t nbytes,
                size_t *buf_size, void **buf)
{
    ...
    if (flags & H5Z_FLAG_REVERSE) {
        ...
        buf_size_out =
            elem_size * jpegInfo.output_height * jpegInfo.output_width * jpegInfo.output_components;
        ...
        jpeg_mem_dest(&jpegInfo, (unsigned char **)&outData, (unsigned long *)&outSize);
