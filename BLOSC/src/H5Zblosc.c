...
static size_t blosc_filter(unsigned int flags, size_t cd_nelmts, const unsigned int cd_values[],
...
const H5Z_class2_t blosc_H5Filter[1] = {{
    ...
    "HDF5 blosc filter; see "
    "https://github.com/HDFGroup/hdf5_plugins/blob/master/docs/RegisteredFilterPlugins.md", /**< Filter name
                                                                                               for debugging
                                                                                             */
 ...
 */
herr_t
blosc_set_local(hid_t dcpl, hid_t type, hid_t space)
{
 ...
 */
size_t
blosc_filter(unsigned int flags, size_t cd_nelmts, const unsigned int cd_values[], size_t nbytes,
